...
<main class="">
  <div class="MidFlex test">
    <div class="Column Center Spacing boxshadow Color4">
    ...
    <div class="Column Center Spacing boxshadow Color1">
      <h1>Need Help?  </h1> 
    ...
    <div class="Column Center Spacing boxshadow Color3">
  ...
  <form class="Column Boxshadow padding3" method="POST">
      <div>
        <h1>Credentials</h1>
      </div>
        UserName: <input class="Margin Full BorderBottom" placeholder="newUserName" name="newUserName" value="<?php echo $_SESSION["value"]["username"]; ?>"/>
        Password: <input class="Margin Full BorderBottom" placeholder="newPassword" type="password" name="newPassword" value="<?php echo $_SESSION["value"]["password"]; ?>"/>
        First Name: <input class="Margin Full BorderBottom" placeholder="newFirstName" name="newFirstName" value="<?php echo $_SESSION["value"]["firstname"]; ?>"/>
        Surname: <input class="Margin Full BorderBottom" placeholder="newSurname" name="newSurname" value="<?php echo $_SESSION["value"]["surname"]; ?>"/>
        Occupation: <input class="Margin Full BorderBottom" placeholder="newOccupation" name="newOccupation" value="<?php echo $_SESSION["value"]["occupation"]; ?>" />
        EmailAddress: <input class="Margin Full BorderBottom" placeholder="newEmail" name="newEmail" value="<?php echo $_SESSION["value"]["email"]; ?>"/>
      <button class="Green boxshadow textColor1 border buttonExtras" type="submit"> Change Preferences</button>
  </form>
